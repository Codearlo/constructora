    ...
    return (
        <section className="container" id="portafolio">
            ...
            <div style={{ 
                ...
                autoRows: '300px', // Altura base
                gap: '20px' 
            }}>
                {/* Item Grande (Destacado) */}
                <motion.div 
                    whileHover={{ scale: 0.98 }}
                    style={{ 
                        gridColumn: 'span 2', // Ocupa 2 columnas si hay espacio
                    ...
                    className="portfolio-item-large" // Clase auxiliar para media queries si fuera necesario
                >
                    <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1200&q=80" alt="Edificio Corporativo" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                ...
                {/* Items Normales */}
                <motion.div whileHover={{ scale: 0.98 }} style={{ borderRadius: 'var(--radius-lg)', overflow: 'hidden', position: 'relative' }}>
                ...
                <motion.div whileHover={{ scale: 0.98 }} style={{ borderRadius: 'var(--radius-lg)', overflow: 'hidden', position: 'relative' }}>
                 ...
                 <motion.div whileHover={{ scale: 0.98 }} style={{ borderRadius: 'var(--radius-lg)', overflow: 'hidden', position: 'relative', background: '#1a1a1a', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
